/*
  ...
  - Added the required column `updatedAt` to the `BannedUser` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "BannedUser" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
